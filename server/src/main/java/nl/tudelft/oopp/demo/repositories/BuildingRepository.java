...
public interface BuildingRepository extends JpaRepository<Building, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO building (id, name, room_count, address) VALUES (:id, :name, :room_count, :address)", nativeQuery = true)
    public void insertBuilding(@Param("id") int id, @Param("name") String name, @Param("room_count") int room_count, @Param("address") String address);
