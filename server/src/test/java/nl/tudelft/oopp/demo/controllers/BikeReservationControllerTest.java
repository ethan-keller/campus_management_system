...
class BikeReservationControllerTest {
    ...
    @MockBean
    private BikeReservationController controller;
    ...
    void getBikeReservationTest() throws Exception {
        when(controller.getBikeReservation(anyInt())).thenReturn(br2);
    ...
    void getBikeReservationsTest() throws Exception {
        when(controller.getBikeReservations()).thenReturn(brList);
    ...
    void getBuildingBikeReservationTest() throws Exception {
        when(controller.getBuildingBikeReservation(anyInt())).thenReturn(brList);
    ...
    void getUserBikeReservationsTest() throws Exception {
        when(controller.getUserBikeReservations(anyString())).thenReturn(brList);
